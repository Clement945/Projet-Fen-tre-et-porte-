...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="style/porte_bois.css"/>
...
<div id="image-coulissant2">
    <div id="image-coulissant" class="animated">
        ...
        <img src="./image/porte_bois3.png" title="image porte" alt="image porte" id="image3"/>
        <img src="./image/porte_bois4.png" title="image porte" alt="image porte" id="image4"/>
        <img src="./image/porte_bois5.png" title="image porte" alt="image porte" id="image5"/>
        <img src="./image/porte_bois6.png" title="image porte" alt="image porte" id="image5"/>
        <img src="./image/porte_bois7.png" title="image porte" alt="image porte" id="image5"/>
        <img src="./image/porte_bois8.png" title="image porte" alt="image porte" id="image5"/>
...
<div  class="text">
    ...
    <p>Notre collection de <strong>portes d’entrée BOIS</strong> est notre propre écriture. Un univers d’exception, dans lequel nos matériaux de prédilection rencontrent la couleur, le verre, le métal… s’inscrivent dans des formes inédites… côtoient des techniques d’usinage inventives… expriment avec force modernité et authenticité.<br/> <br/>
...
<img src="./image/porte_bois9.png" title="image porte bois" alt="image porte bois" class="image6 image6_1"/>
<img src="./image/porte_bois10.png" title="image porte bois" alt="image porte bois" class="image6 image6_2"/>
<img src="./image/porte_bois11.png" title="image porte bois" alt="image porte bois" class="image6 image6_3"/>
...
<img src="./image/porte_bois12.png" title="image porte bois" alt="image porte bois" class="image6 image6_1"/>
...
<div class="listepuce">
    <ul>
        <li>Toutes nos portes Bois sont conçues pour offrir une isolation thermique optimale (Ud selon la compostions de chaque modèle).</li></br>
...
<div class="listepuce">
    <ul>
        <li>Dotée d’une serrure automatique de 6 points dont 2 crochets.
            « sécurité » (2 rouleaux, 2 crochets, 1 pêne dormant + gâches réglables).</li></br>
            ...
            <li>La porte d’entrée ARCADES et BAIES présente une conception garantie d’une sécurité accrue.</li></br>
    </ul>
...
<div class="listepuce">
    <ul>
        <li>Les notions de création et de qualité sont, pour ARCADES et BAIES indissociables de celles du respect de l’environnement.</li></br>
            <li>Nos portes sont conçues avec l’objectif de réduire leur impact écologique.</li></br>
